...
// Source: github.com/int128/gradleupdate/domain/gateways (interfaces: PullRequestRepository)
...
import (
	...
	gateways "github.com/int128/gradleupdate/domain/gateways"
	reflect "reflect"
)
...
func (m *MockPullRequestRepository) Query(arg0 context.Context, arg1 gateways.PullRequestQuery) ([]domain.PullRequest, error) {
