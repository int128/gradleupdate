...
// Source: github.com/int128/gradleupdate/gateways/interfaces (interfaces: BadgeLastAccessRepository,GetRepositoryQuery,RepositoryRepository,PullRequestRepository,GitService,GradleReleaseRepository,Credentials,Toggles,Queue)
