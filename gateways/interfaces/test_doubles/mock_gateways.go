...
// Source: github.com/int128/gradleupdate/gateways/interfaces (interfaces: BadgeLastAccessRepository,RepositoryRepository,PullRequestRepository,GitService,GradleReleaseRepository,Credentials,Toggles,Queue)
