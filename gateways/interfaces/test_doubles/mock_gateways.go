...
// Source: github.com/int128/gradleupdate/gateways/interfaces (interfaces: RepositoryError,BadgeLastAccessRepository,RepositoryLastUpdateRepository,RepositoryRepository,PullRequestRepository,GitService,GradleService)
